export default {
  ...
  head: {
    title: 'Filip Švehla | Czech Artist',
    htmlAttrs: {
      lang: 'en',
    },
    meta: [
      ...
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        hid: 'description',
        name: 'description',
        content: 'Young Czech Artist, Paintings and Installations',
      },
      {
        hid: 'og:description',
        property: 'og:description',
        content: 'Young Czech Artist',
      },
      { hid: 'og:image', property: 'og:image', content: '/background.png' },
    ],
    link: [
